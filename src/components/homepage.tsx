...
export function Homepage() {
	...
	return (
	  <div className="min-h-screen bg-gradient-to-br from-gray-800 to-gray-600 flex flex-col items-center justify-center p-4 text-white">
		<div className="max-w-6xl w-full bg-gray-900/80 backdrop-blur-lg rounded-2xl p-8 shadow-2xl">
			...
			<div>
			  ...
			  <div className="flex items-center">
				<input
				  ...
				  className="flex-grow px-4 py-2 rounded-l-lg bg-gray-800/80 focus:outline-none focus:ring-2 focus:ring-white"
				/>
				<div className="bg-gray-800/80 px-4 py-2 rounded-r-lg">
			...
			<div>
			  ...
			  <div className="flex items-center">
				<input
				  ...
				  value={outputUrl}
				  readOnly
				  className="flex-grow px-4 py-2 rounded-l-lg bg-gray-800/80"
				/>
				<button
				  onClick={() => navigator.clipboard.writeText(outputUrl)}
				  className="bg-gray-800/80 px-4 py-2 rounded-r-lg hover:bg-gray-700 transition-colors"
				>
				  Copy
				</button>
			  </div>
		  ...
		  <div className="flex flex-col items-center space-y-4">
			<a
			  ...
			  className="inline-flex items-center px-6 py-3 bg-gray-900 text-white rounded-full font-semibold hover:bg-gray-700 transition-colors"
			>
  ...
  function Feature({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
	return (
	  <div className="bg-gray-800/80 rounded-xl p-6 transition-all hover:bg-gray-700/80 flex flex-col h-full">
		<div className="flex items-center mb-4">
		  <div className="mr-4 p-2 bg-gray-800/50 rounded-full">{icon}</div>
